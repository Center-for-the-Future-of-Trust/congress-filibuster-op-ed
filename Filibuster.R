...
# 0) Config
# -------------------------
data_path <- "/local/scratch/group/guldigroup/climate_change/congress/congress_data_daily_by_speaker_with_metadata_07-29-25.csv"

top_n_per_decade <- 3
k_words <- 4

output_dir <- "/local/scratch/group/guldigroup/climate_change/congress/filibuster_visualization"
...
Sys.setenv(GROQ_API_KEY = "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")
